...
const LoginForm = ({ redirectUrl }) => {
  ...
  return (
    <>
      <form className='m-auto my-16 max-w-[500px] bg-gray-800 p-8 border-2 shadow-md rounded-md'>
        {loading ? (
          <Loader />
        ) : (
          <>
            <h2 className='text-center mb-4 text-white'>Welcome user, please login here</h2>
            <div className="mb-4">
